...
#C:\Users\kaan_\Desktop\Final\bank-additional\bank-additional\finalpro.sav
loaded_model = pickle.load(open(r"C:\Users\kaan_\Desktop\Final\bank-additional\finalpro.sav", 'rb'))
...
def main():
    ...
    marital = st.text_input('Marital Status -> 0-3')
    ...
    contact_month = st.text_input('Contact Month')
